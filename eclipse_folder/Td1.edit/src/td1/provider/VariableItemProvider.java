...
/**
 * This is the item provider adapter for a {@link td1.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Td1Package.Literals.VARIABLE__DATATYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProcessesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_processes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_processes_feature", "_UI_Variable_type"),
				 Td1Package.Literals.VARIABLE__PROCESSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Td1Package.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_components_feature", "_UI_Variable_type"),
				 Td1Package.Literals.VARIABLE__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case Td1Package.VARIABLE__NAME:
