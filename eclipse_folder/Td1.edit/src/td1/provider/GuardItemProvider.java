...
/**
 * This is the item provider adapter for a {@link td1.Guard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Td1Package.Literals.GUARD__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guard_Body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guard_Body_feature", "_UI_Guard_type"),
				 Td1Package.Literals.GUARD__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
