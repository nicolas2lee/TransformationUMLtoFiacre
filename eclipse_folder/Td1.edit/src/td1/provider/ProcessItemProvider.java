...
/**
 * This is the item provider adapter for a {@link td1.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_variables_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_variables_feature", "_UI_Process_type"),
				 Td1Package.Literals.PROCESS__VARIABLES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Td1Package.Literals.PROCESS__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInitStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_initState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_initState_feature", "_UI_Process_type"),
				 Td1Package.Literals.PROCESS__INIT_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Td1Package.Literals.PROCESS__TRANSITIONS);
			childrenFeatures.add(Td1Package.Literals.PROCESS__STATES);
		}
	...
	public String getText(Object object) {
		String label = ((td1.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(td1.Process.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROCESS__TRANSITIONS,
				 Td1Factory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROCESS__STATES,
				 Td1Factory.eINSTANCE.createState()));
	}
