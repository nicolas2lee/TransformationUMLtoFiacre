...
/**
 * This is the item provider adapter for a {@link td1.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Td1Package.Literals.PROGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Td1Package.Literals.PROGRAM__COMPONENTS);
			childrenFeatures.add(Td1Package.Literals.PROGRAM__VARIABLE);
			childrenFeatures.add(Td1Package.Literals.PROGRAM__PROCESSES);
			childrenFeatures.add(Td1Package.Literals.PROGRAM__DATATYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROGRAM__COMPONENTS,
				 Td1Factory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROGRAM__VARIABLE,
				 Td1Factory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROGRAM__PROCESSES,
				 Td1Factory.eINSTANCE.createProcess()));

		newChildDescriptors.add
			(createChildParameter
				(Td1Package.Literals.PROGRAM__DATATYPES,
				 Td1Factory.eINSTANCE.createDataType()));
	}
