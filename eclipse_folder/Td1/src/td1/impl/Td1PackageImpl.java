 ...
 * @generated
 */
public class Td1PackageImpl extends EPackageImpl implements Td1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see td1.Td1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Td1PackageImpl() {
		super(eNS_URI, Td1Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Td1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Td1Package init() {
		if (isInited) return (Td1Package)EPackage.Registry.INSTANCE.getEPackage(Td1Package.eNS_URI);

		// Obtain or create and register package
		Td1PackageImpl theTd1Package = (Td1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Td1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Td1PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theTd1Package.createPackageContents();

		// Initialize created meta-data
		theTd1Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTd1Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Td1Package.eNS_URI, theTd1Package);
		return theTd1Package;
	}
	 ...
	 * @generated
	 */
	public Td1Factory getTd1Factory() {
		return (Td1Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(processEClass, td1.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcess_Transitions(), this.getTransition(), null, "transitions", null, 1, -1, td1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Variables(), this.getVariable(), this.getVariable_Processes(), "variables", null, 0, -1, td1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcess_Name(), ecorePackage.getEString(), "Name", "", 0, 1, td1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_States(), this.getState(), null, "states", null, 1, -1, td1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_InitState(), this.getState(), this.getState_Process(), "initState", null, 1, 1, td1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGuard_Body(), ecorePackage.getEString(), "Body", null, 0, 1, Guard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
