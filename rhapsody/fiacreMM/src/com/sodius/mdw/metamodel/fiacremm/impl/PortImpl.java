 ...
 *   <li>{@link com.sodius.mdw.metamodel.fiacremm.impl.PortImpl#getProcess <em>Process</em>}</li>
...
public class PortImpl extends DefaultMDWEObject implements Port
{
  ...
  public com.sodius.mdw.metamodel.fiacremm.Process getProcess()
  {
    if (process != null && process.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FiacreMMPackage.PORT__PROCESS, oldProcess, process));
      }
    }
    return process;
  }
  ...
  public void setProcess(com.sodius.mdw.metamodel.fiacremm.Process newProcess)
  {
    ...
    process = newProcess;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FiacreMMPackage.PORT__PROCESS, oldProcess, process));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FiacreMMPackage.PORT__NAME:
        return getName();
      case FiacreMMPackage.PORT__PROCESS:
