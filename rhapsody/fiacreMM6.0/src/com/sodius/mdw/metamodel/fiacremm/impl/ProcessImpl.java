 ...
 *   <li>{@link com.sodius.mdw.metamodel.fiacremm.impl.ProcessImpl#getOutPorts <em>Out Ports</em>}</li>
...
public class ProcessImpl extends DefaultMDWEObject implements com.sodius.mdw.metamodel.fiacremm.Process
{
  ...
  /**
   * The cached value of the '{@link #getOutPorts() <em>Out Ports</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getOutPorts()
   * @generated
   ...
   * @generated
   */
  public NotificationChain basicSetOutPorts(Port newOutPorts, NotificationChain msgs)
  {
    Port oldOutPorts = outPorts;
    outPorts = newOutPorts;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FiacreMMPackage.PROCESS__OUT_PORTS, oldOutPorts, newOutPorts);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setOutPorts(Port newOutPorts)
  {
    if (newOutPorts != outPorts)
    {
      NotificationChain msgs = null;
      if (outPorts != null)
        msgs = ((InternalEObject)outPorts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FiacreMMPackage.PROCESS__OUT_PORTS, null, msgs);
      if (newOutPorts != null)
        msgs = ((InternalEObject)newOutPorts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FiacreMMPackage.PROCESS__OUT_PORTS, null, msgs);
      msgs = basicSetOutPorts(newOutPorts, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FiacreMMPackage.PROCESS__OUT_PORTS, newOutPorts, newOutPorts));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case FiacreMMPackage.PROCESS__OUT_PORTS:
