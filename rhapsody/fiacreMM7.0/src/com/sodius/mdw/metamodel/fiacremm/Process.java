 ...
 *   <li>{@link com.sodius.mdw.metamodel.fiacremm.Process#getOutPorts <em>Out Ports</em>}</li>
...
public interface Process extends MDWEObject, EModelElement
{
   ...
   * @see #setOutPorts(Port)
   * @see com.sodius.mdw.metamodel.fiacremm.FiacreMMPackage#getProcess_OutPorts()
  ...
  /**
   * Sets the value of the '{@link com.sodius.mdw.metamodel.fiacremm.Process#getOutPorts <em>Out Ports</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
