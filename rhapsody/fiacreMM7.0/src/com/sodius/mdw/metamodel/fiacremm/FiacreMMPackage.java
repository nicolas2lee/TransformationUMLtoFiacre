...
public interface FiacreMMPackage extends EPackage
{
   ...
   * @ordered
   */
  int PROCESS__OUT_PORTS = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 7;

  /**
   * The feature id for the '<em><b>Allunique Triggers</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PROCESS__ALLUNIQUE_TRIGGERS = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 8;
  ...
  /**
   * The feature id for the '<em><b>Arg Size</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int TRIGGER__ARG_SIZE = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int TRIGGER_FEATURE_COUNT = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 5;
   ...
   * @ordered
   */
  int PORT__COMPONENTS = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int PORT_FEATURE_COUNT = EcorePackage.EMODEL_ELEMENT_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the containment reference '{@link com.sodius.mdw.metamodel.fiacremm.Process#getOutPorts <em>Out Ports</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Out Ports</em>'.
   * @see com.sodius.mdw.metamodel.fiacremm.Process#getOutPorts()
   * @see #getProcess()
   * @generated
   */
  EReference getProcess_OutPorts();

  /**
   * Returns the meta object for the containment reference list '{@link com.sodius.mdw.metamodel.fiacremm.Process#getAlluniqueTriggers <em>Allunique Triggers</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Allunique Triggers</em>'.
   * @see com.sodius.mdw.metamodel.fiacremm.Process#getAlluniqueTriggers()
   * @see #getProcess()
   * @generated
   */
  EReference getProcess_AlluniqueTriggers();
  ...
  /**
   * Returns the meta object for the attribute '{@link com.sodius.mdw.metamodel.fiacremm.Trigger#getArgSize <em>Arg Size</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Arg Size</em>'.
   * @see com.sodius.mdw.metamodel.fiacremm.Trigger#getArgSize()
   * @see #getTrigger()
   * @generated
   */
  EAttribute getTrigger_ArgSize();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference PROCESS__OUT_PORTS = eINSTANCE.getProcess_OutPorts();

    /**
     * The meta object literal for the '<em><b>Allunique Triggers</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference PROCESS__ALLUNIQUE_TRIGGERS = eINSTANCE.getProcess_AlluniqueTriggers();
    ...
    /**
     * The meta object literal for the '<em><b>Arg Size</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute TRIGGER__ARG_SIZE = eINSTANCE.getTrigger_ArgSize();
